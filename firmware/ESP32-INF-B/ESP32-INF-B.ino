// RiegoIQ - ESP32 Nodo B Sector Inferior
// Nodo B controla V3, V4 y lee S3, S4.
...
const char* DEVICE_ID = "ESP32-INF-B";
...
const int PIN_SENSOR[SENSOR_COUNT]   = { 34, 35 };
const int SENSOR_VALVE[SENSOR_COUNT] = {  3,  4 };
const int PIN_RELE[RELAY_COUNT]      = { 18, 19 };
const int RELE_VALVE[RELAY_COUNT]    = {  3,  4 };

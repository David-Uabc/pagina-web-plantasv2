// RiegoIQ - Nodo mixto ESP32 (valvulas y sensores 1, 2, 3)
// Usa este mismo sketch para Superior o Inferior.
// Solo cambia DEVICE_ID y SECTOR antes de subirlo.
...
const char* DEVICE_ID = "ESP32-INF-01";
...
const int PIN_SENSOR[SENSOR_COUNT]   = { 36, 39, 34 };
const int SENSOR_VALVE[SENSOR_COUNT] = {  1,  2,  3 };
const int PIN_RELE[RELAY_COUNT]      = { 16, 17, 18 };
const int RELE_VALVE[RELAY_COUNT]    = {  1,  2,  3 };
...
bool relActivo[RELAY_COUNT] = { false, false, false };
int ultimaHumedad[SENSOR_COUNT] = { -1, -1, -1 };

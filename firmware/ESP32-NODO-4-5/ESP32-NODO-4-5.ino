// RiegoIQ - Nodo mixto ESP32 (valvulas y sensores 4, 5)
...
const char* DEVICE_ID = "ESP32-INF-02";
...
const int PIN_SENSOR[SENSOR_COUNT]   = { 35, 32 };
const int SENSOR_VALVE[SENSOR_COUNT] = {  4,  5 };
const int PIN_RELE[RELAY_COUNT]      = { 19, 13 };
const int RELE_VALVE[RELAY_COUNT]    = {  4,  5 };

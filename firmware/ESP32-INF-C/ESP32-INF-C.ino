// RiegoIQ - ESP32 Nodo C Sector Inferior
// Nodo C controla V5 y lee S5.
...
const char* DEVICE_ID = "ESP32-INF-C";
...
const int PIN_SENSOR[SENSOR_COUNT]   = { 32 };
const int SENSOR_VALVE[SENSOR_COUNT] = {  5 };
const int PIN_RELE[RELAY_COUNT]      = { 13 };
const int RELE_VALVE[RELAY_COUNT]    = {  5 };
...
bool relActivo[RELAY_COUNT] = { false };
int ultimaHumedad[SENSOR_COUNT] = { -1 };

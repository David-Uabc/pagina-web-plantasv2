...
/**
 * OfflineBanner — aparece cuando el backend no responde
 * y muestra datos cacheados. Se cierra solo cuando vuelve la conexión.
 * Uso: <OfflineBanner /> en App.jsx dentro del Router
 */
